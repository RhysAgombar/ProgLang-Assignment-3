  ...
  while swapped == true
    ...
    for pos in 0 ... (list.size - 1)
      for i in 0 ... list.size
        if ((i == pos) || (i == (pos + 1)))
          $t = para list[i], :font => "Monospace 12px", :stroke => red
        else
          $t = para list[i], :font => "Monospace 12px", :stroke => black
        end    
      end
...
def bubble_sort(list)
  ...
  $t = para "Bubble Sort Complete", :font => "Monospace 12px", :stroke => black
  $t = para "\n", :font => "Monospace 12px", :stroke => black
...
def selection_sort(list)
  ...
  $t = para "\n", :font => "Monospace 12px", :stroke => black
  $t = para "Selection Sort Complete", :font => "Monospace 12px", :stroke => black, :displace_left => 0
  $t = para "\n", :font => "Monospace 12px", :stroke => black
...
def genButtons
  button "Quick Sort", :displace_top => 385 do
    qButtonClick
  end
  
  button "Selection Sort", :displace_top => 385, :displace_left => 0 do
    sButtonClick
  end
  
  button "Bubble Sort", :displace_top => 385, :displace_left => 0 do
    bButtonClick
  end
end

Shoes.app :width => 376, :height => 415 do
